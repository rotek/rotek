...
<script type="text/javascript" >
	var news_pic_upload_url = basePath+"${news_pic_upload_url}";
	...
	var oFCKeditorOptions = {
	        ...
	        Config: {
	            ...
	            ImageUploadURL : news_pic_upload_url,
...
<script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/js_app/admin/restaurant/restaurants.js">
</script>
