    	    ...
    	    items : [{
    	        ...
    	        maxLength: 250
    				...
    				store : new Ext.data.Store({
        				...
        				listeners : {
        					load : function (){
    	    					Ext.getCmp('super_menu').setValue(data.super_menu_id);
    	    					data.role_id = null;
        					}
        				}
    				})
                 ...
                 renderer : function(v, metaData, record, rowIndex, colIndex, store){
              	   ...
              	   for(var i = 0;i<buttonList.length;i++){
              		   ...
              		   if(button_id == button_id_){
              			   buttonsGrid.getSelectionModel().selectRow(rowIndex,true);
              			   return button_id;
              		   }
              	   }
              	   return button_id;
      ...
      var updateWindow = new CTA.common.UpdateWindow({
        ...
        handler : function(){
            ...
            if(formPanel.getForm().isValid()){
				...
				var buttonList_ = buttonsGrid.getSelectionModel().getSelections();
				var buttonList = [];
