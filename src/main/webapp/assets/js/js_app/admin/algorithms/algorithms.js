//设置客户资料信息
Ext.ns("ROTEK.ALGORITHMS");
ROTEK.ALGORITHMS.params = {
	//全局gridpanel的参数
	gridParam : {
			url :   basePath + "/admin/Algorithm/listAlgorithms",
		    dataList:[{
		          index:'id',
		          header:'算法设置ID',
		          width : 30,
	...
	url : {
		addUrl : basePath + "/admin/Algorithm/addAlgorithms",
		detailUrl : basePath + "/admin/Algorithm/getAlgorithmsDetail",
		modifyUrl : basePath + "/admin/Algorithm/modifyAlgorithms",
		dropUrl : basePath + "/admin/Algorithm/deleteAlgorithms",
		listCustomersUrl : basePath + "/admin/Algorithm/listCustomers"
	}
};

var gridPanel = CTA.common.GridPanel.createGridPanel(ROTEK.ALGORITHMS.params.gridParam);
	...
	toolbar.get("button_add").setHandler(function() {
		...
		var saveHandler = function(){
	        ...
	        if(formPanel.getForm().isValid()){
	          ...
	          formPanel.commit({
	            url : ROTEK.ALGORITHMS.params.url.addUrl
	          });
	        }
	    };
		  //定义添加的窗口
