...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" style="border:solid 1px #dddddd;margin:0 50px 0 0" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "展示 _START_ 到 _END_ 条，共 _TOTAL_ 条",
