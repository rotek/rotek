...
(function() {
    ...
    function w() {
        ...
        e = function(a, b) {
            var c, d;
            typeof a !== "object" && (a = {});
            for (d in b) b.hasOwnProperty(d) && (c = b[d], a[d] = c && typeof c === "object" && Object.prototype.toString.call(c) !== "[object Array]" && typeof c.nodeType !== "number" ? e(a[d] || {},
            c) : b[d]);
            return a
        };
    ...
    function H(a, b, c) {
        var d, e;
        if (ma(b)) t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (t(b) && aa(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function ja(a) {
        return Pa(a) ? a: [a]
    ...
    function Ha(a, b) {
        ...
        e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                h = L.lang,
                i = void 0,
                /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Ga(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep: "")) : e = ra(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}": "{"
    ...
    Eb = {
        ...
        V.HighchartsAdapter = V.HighchartsAdapter || a && {
            ...
            fireEvent: function(b, c, d, e) {
                var f = a.Event(c),
                g = "detached" + c,
                h; ! Fa && d && (delete d.layerX, delete d.layerY);
                u(f, d);
    ...
    xa.prototype = {
        ...
        attr: function(a, b) {
            ...
            n = H(g, c) || this[c] || 0,
            c !== "d" && c !== "visibility" && c !== "fill" && (n = parseFloat(n));
            else {
                for (c in a) if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                    ...
                    else if (c === "dashstyle") if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid") d = ba;
                    else {
                        if (d) {
                    ...
                    e || (e = F.createElementNS(Ma, "title"), g.appendChild(e)),
                    e.textContent = d;
                    c === "strokeWidth" && (c = "stroke-width");
                    if (c === "stroke-width" || c === "stroke") {
                        this[c] = d;
                        if (this.stroke && this["stroke-width"]) H(g, "stroke", this.stroke),
                        H(g, "stroke-width", this["stroke-width"]),
                        this.hasStroke = !0;
        ...
        on: function(a, b) {
            ...
            d.onclick = function(a) { (za.indexOf("Android") === -1 || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
            }) : d["on" + a] = b;
            return this
        },
        ...
        updateTransform: function() {
            ...
            a = ["translate(" + a + "," + b + ")"];
            e ? a.push("rotate(90) scale(-1,1)") : f && a.push("rotate(" + f + " " + (this.x || 0) + " " + (this.y || 0) + ")"); (t(c) || t(d)) && a.push("scale(" + o(c, 1) + " " + o(d, 1) + ")");
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || ma(c)) this.alignTo = d = c || "renderer",
                oa(f, this),
                f.push(this),
                c = null
        ...
        getBBox: function() {
            ...
            d = this.textStr;
            var h;
            if (d === "" || Zb.test(d)) h = d.length + "|" + f.fontSize + "|" + f.fontFamily,
            a = b.cache[h];
            if (!a) {
                ...
                if (b.isSVG) {
                    ...
                    if (e) a.width = O(d * ha(g)) + O(c * ca(g)),
                    a.height = O(d * ca(g)) + O(c * ha(g))
                }
                this.bBox = a;
                h && (b.cache[h] = a)
            }
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) H(f, "height", s(H(f, "height") - h, 0)),
                    f.cutHeight = h;
    ...
    sa.prototype = {
        ...
        destroy: function() {
            ...
            this.subPixelFix && X(V, "resize", this.subPixelFix);
        ...
        buildText: function(a) {
            ...
            c = this,
            d = c.forExport,
            e = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="(http[^"]+)"/, i = H(b, "x"), j = a.styles, k = a.textWidth, l = j && j.lineHeight, m = f.length, p = function(a) {
            ...
            function(e, f) {
                ...
                function(e) {
                    if (e !== "" || l.length === 1) {
                        ...
                        q;
                        g.test(e) && (q = e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), H(o, "style", q));
                        h.test(e) && !d && (H(o, "onclick", 'location.href="' + e.match(h)[1] + '"'), z(o, {
                            cursor: "pointer"
                        }));
                        e = (e.replace(/<(.|\n)*?>/g, "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                        if (e !== " " && (o.appendChild(F.createTextNode(e)), m ? n.dx = 0 : n.x = i, H(o, n), !m && f && (!da && d && z(o, {
                            display: "block"
                        }), H(o, "dy", p(o), mb && o.offsetHeight)), b.appendChild(o), m++, k)) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = e.length > 1 && j.whiteSpace !== "nowrap", r, s, v = a._clipHeight, t = [], u = p(), fa = 1; n && (e.length || t.length);) delete a.bBox,
                        r = a.getBBox(),
                        s = r.width,
                        !da && c.forExport && (s = c.measureSpanWidth(o.firstChild.data, a.styles)),
                        r = s > k,
                        !r || e.length === 1 ? (e = t, t = [], e.length && (fa++, v && fa * u > v ? (e = ["..."], a.attr("title", a.textStr)) : (o = F.createElementNS(Ma, "tspan"), H(o, {
                            dy: u,
                            x: i
                        }), q && H(o, "style", q), b.appendChild(o), s > k && (k = s)))) : (o.removeChild(o.firstChild), t.unshift(e.pop())),
                        e.length && o.appendChild(F.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        },
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            o = h.style;
            delete h.style;
            A(j.element, Fa ? "mouseover": "mouseenter",
            function() {
                k !== 3 && j.attr(f).css(n)
            });
            A(j.element, Fa ? "mouseout": "mouseleave",
            function() {
                k !== 3 && (l = [e, f, g][k], m = [p, n, $][k], j.attr(l).css(m))
            });
            j.setState = function(a) { (j.state = k = a) ? a === 2 ? j.attr(g).css($) : a === 3 && j.attr(h).css(o) : j.attr(e).css(p)
            };
            return j.on("click",
            function() {
                k !== 3 && d.call(j)
        ...
        color: function(a, b, c) {
            ...
            if (g) {
                ...
                p = p.join(",");
                h[p] ? a = h[p].id: (c.id = a = "highcharts-" + Db++, h[p] = i = d.createElement(g).attr(c).add(d.defs), i.stops = [], q(j,
                function(a) {
                    f.test(a[1]) ? (e = Ba(a[1]), k = e.get("rgb"), l = e.get("a")) : (k = a[1], l = 1);
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (Hb) {
                    if (!J) a = v( - pb * s),
                    b = h ? -fa: 0,
                    n.box = J = d ? p.symbol(d, a, b, n.width, n.height, P) : p.rect(a, b, n.width, n.height, 0, P[Ub]),
                    J.add(n);
                    J.isImg || J.attr(w({
                        width: n.width,
                        height: n.height
            ...
            function k() {
                ...
                c;
                c = h ? 0 : fa;
                if (t(Ca) && (a === "center" || a === "right")) b += {
                    center: 0.5,
                    right: 1
                } [a] * (Ca - x.width); (b !== o.x || c !== o.y) && o.attr({
                    x: b,
                    y: c
                });
                o.x = b;
    ...
    if (!da && !ka) Highcharts.VMLElement = qa = {
        ...
        updateTransform: xa.prototype.htmlUpdateTransform,
        setSpanRotation: function() {
            var a = this.rotation,
            b = ca(a * La),
            c = ha(a * La);
            z(this.element, {
                filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : ba
            })
        },
        getSpanCorrection: function(a, b, c, d, e) {
            ...
            e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), z(this.element, {
                textAlign: e
            }))
        },
        pathToVML: function(a) {
            for (var b = a.length,
            c = []; b--;) if (ua(a[b])) c[b] = v(a[b] * 10) - 5;
            else if (a[b] === "Z") c[b] = "x";
        ...
        attr: function(a, b) {
            ...
            a[c] = b);
            if (ma(a)) c = a,
            n = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight: this[c];
                ...
                m = !0;
                else if (Aa(c, ["x", "y", "width", "height"]) !== -1) this[c] = d,
                c === "x" || c === "y" ? c = {
                    x: "left",
                    y: "top"
                } [c] : d = s(0, d),
                ...
                this[c] = d,
                ua(d) && (d += "px");
                else if (c === "dashstyle")(f.getElementsByTagName("stroke")[0] || Z(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid",
                this.dashstyle = d,
                m = !0;
                else if (c === "fill") if (h === "SPAN") g.color = d;
                else {
                    if (h !== "IMG") f.filled = d !== ba ? !0 : !1,
                    d = i.color(d, f, c, this),
                    c = "fillcolor"
                } else if (c === "opacity") m = !0;
                else if (h === "shape" && c === "rotation") this[c] = f.style[c] = d,
                f.style.left = -v(ha(d * La) + 1) + "px",
                f.style.top = v(ca(d * La)) + "px";
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= 3; e++) {
                    ...
                    if (c) h.cutOff = l + 1;
                    j = ['<stroke color="', a.color || "black", '" opacity="', n * e, '"/>'];
    ...
    qa = {
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                p = m.x2 || m[2] || 0,
                m = m.y2 || m[3] || 0,
                s = 'angle="' + (90 - T.atan((m - a) / (p - c)) * 180 / Ka) + '"',
                v();
                else {
                    var j = m.r,
                    u = j * 2,
            ...
            } else if (g.test(a) && b.tagName !== "IMG") f = Ba(a),
            h = ["<", c, ' opacity="', f.get("a"), '"/>'],
        ...
        symbols: {
            ...
            rect: function(a, b, c, d, e) {
                var f = a + c,
                g = b + d,
                h; ! t(e) || !e.r ? f = sa.prototype.symbols.square.apply(0, arguments) : (h = y(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                return f
            }
        }
    },
    ...
    rb.prototype = w(sa.prototype, qa),
    Za = rb;
    ...
    Ya.prototype = {
        addLabel: function() {
            ...
            b = a.labelFormatter.call({
                ...
                value: a.isLog ? ga(na(f)) : f
            });
            g = d && {
                width: s(1, v(d - 2 * (h.padding || 10))) + "px"
            };
            g = u(g, h.style);
            if (t(e)) e && e.attr({
                text: b
        ...
        handleOverflow: function(a, b) {
            ...
            if (o) x = (d = d.ticks[i[a + (e ? 1 : -1)]]) && d.label.xy && d.label.xy.x + d.getLabelSides()[e ? 0 : 1],
            i = x,
            e && !h || f && h ? g + k < l && (g = l - k, d && g + j > i && (c = !1)) : g + j > m && (g = m - j, d && g + k < i && (c = !1)),
            b.x = g;
            return c
        },
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            ...
            p && i.side === 2 && (b -= m - m * ca(p * La)); ! t(e.y) && !p && (b += m - c.getBBox().height / 2);
            if (l) c.line = g / (h || 1) % l,
        ...
        render: function(a, b, c) {
            ...
            G = w.x,
            w = w.y,
            C = g && G === d.pos + d.len || !g && w === d.pos ? -1 : 1;
            this.isActive = !0;
            if (n) {
            ...
            if (m && x) t === "inside" && (x = -x),
            d.opposite && (x = -x),
            h = this.getMarkPath(G, w, x, m * C, g, f),
            p ? p.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(G)) i.xy = w = this.getLabelPosition(G, w, i, g, k, I, a, v),
            this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? u = !1 : !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && (u = this.handleOverflow(a, w)),
            v && a % v && (u = !1),
            u && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr": "animate"](w), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Ia(this, this.axis)
        }
    ...
    Qb.prototype = {
        ...
        setOffset: function(a, b) {
            ...
            f = e.alignAttr,
            e.attr({
                visibility: this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? da ? "inherit": "visible": "hidden"
            })
        }
    };
    var Ib = function(a, b) {
    ...
    Ib.prototype = {
        render: function() {
            ...
            if (h) {
                if (n = b.getPlotLinePath(l, h), d = {
                    stroke: J,
                    "stroke-width": h
                },
                m) d.dashstyle = m
            } else if (k) {
                if (j = s(j, b.min - d), i = y(i, b.max + d), n = b.getPlotBandPath(j, i, e), d = {
                    fill: J
                },
    ...
    W.prototype = {
        ...
        getSeriesExtremes: function() {
            ...
            function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && d <= 0 && (d = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = y(o(a.dataMin, d[0]), Ra(d)),
                        a.dataMax = s(o(a.dataMax, d[0]), va(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (t(c) && t(e)) a.dataMin = y(o(a.dataMin, c), c),
        ...
        setAxisTranslation: function(a) {
            ...
            h = !!this.categories,
            i = this.transA;
            if (this.isXAxis || h) g ? (e = g.minPointOffset, f = g.pointRangePadding) : q(this.series,
            function(a) {
        ...
        setTickPositions: function(a) {
            ...
            if (e) ! a && y(b.min, o(b.dataMin, b.min)) <= 0 && pa(10, 1),
            b.min = ga(Ea(b.min)),
            b.max = ga(Ea(b.max));
            if (b.range && t(b.max)) b.userMin = b.min = s(b.min, b.max - b.range),
            b.userMax = b.max,
            b.range = null;
            ...
            b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : h && !l && p === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval: (b.tickInterval = o(l, $ ? 1 : (b.max - b.min) * p / s(b.len, p)), !t(l) && b.len < p && !this.isRadial && !$ && d.startOnTick && d.endOnTick && (n = !0, b.tickInterval /= 4));
            g && !a && q(b.series,
            function(a) {
            ...
            if (!a) ! b.ordinalPositions && (b.max - b.min) / b.tickInterval > s(2 * b.len, 200) && pa(19, !0),
            ...
            if (j || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && Ca && !n.rotation) {
                    for (u = a.reversed ? [].concat(e).reverse() : e; w < Ca;) {
                        j = [];
                        I = !1;
                        for (n = 0; n < u.length; n++) y = u[n],
                        G = (G = f[y].label && f[y].label.getBBox()) ? G.width: 0,
                        C = n % w,
                        G && (y = a.translate(y), j[C] !== r && y < j[C] && (I = !0), j[C] = y + G);
                        if (I) w++;
                        else break
                    }
                ...
                function(b) {
                    if (h === 0 || h === 2 || {
                        1 : "left",
                        3 : "right"
                    } [h] === a.labelAlign) $ = s(f[b].getLabelSize(), $)
                });
                if (a.staggerLines) $ *= a.staggerLines,
                a.labelOffset = $
            } else for (u in f) f[u].destroy(),
            delete f[u];
        ...
        render: function() {
            ...
            if (u || h) if (a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(),
            function(b) {
                p[b] || (p[b] = new Ya(a, b, "minor"));
                v && p[b].isNew && p[b].render(null, !0);
                p[b].render(null, !1, 1)
            }), i.length && (j = i.slice(), (b && c || !b && !c) && j.reverse(), y && (j = j.slice(1).concat([j[0]])), q(j,
            function(b, c) {
                y && (c = c === j.length - 1 ? 0 : c + 1);
                if (!h || b >= a.min && b <= a.max) m[b] || (m[b] = new Ya(a, b)),
                v && m[b].isNew && m[b].render(c, !0, 0.1),
                m[b].render(c, !1, 1)
            }), x && a.min === 0 && (m[ - 1] || (m[ - 1] = new Ya(a, -1, null, !0)), m[ - 1].render( - 1))), J && q(i,
            function(b, c) {
                if (c % 2 === 0 && b < a.max) n[b] || (n[b] = new Ib(a)),
                I = b + x,
                G = i[c + 1] !== r ? i[c + 1] + x: a.max,
                n[b].options = {
                    from: g ? na(I) : I,
                    to: g ? na(G) : G,
                    color: J
            ...
            if (k && w) k[k.isNew ? "attr": "animate"](a.getTitlePosition()),
            k.isNew = !1;
            if (o && o.enabled) {
    ...
    W.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        k = a.count;
        if (t(b)) {
            j >= B.second && (i.setMilliseconds(0), i.setSeconds(j >= B.minute ? 0 : k * Q(i.getSeconds() / k)));
            ...
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[Ua](), p = g ? Ja: (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d),
            j === B.year ? d = ib(h + b * k, 0) : j === B.month ? d = ib(h, l + b * k) : !g && (j === B.day || j === B.week) ? d = ib(h, l, m + b * k * (j === B.day ? 1 : 7)) : d += j * k,
            b++;
            e.push(d);
            q(Fb(e,
            function(a) {
    ...
    W.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        else if (a >= 0.08) for (var f = Q(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++) j = Ea(na(f) * e[h]),
            j > b && (!d || k <= c) && g.push(k),
            k > c && (l = !0),
            k = j
    ...
    $a.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (e && b.options.tooltip.shared && (!i || !i.noSharedTooltip)) {
                g = [];
                j = d.length;
                for (k = 0; k < j; k++) if (d[k].visible && d[k].options.enableMouseTracking !== !1 && !d[k].noSharedTooltip && d[k].tooltipPoints.length && (f = d[k].tooltipPoints[m]) && f.series) f._dist = O(m - f.clientX),
                l = y(l, f._dist),
                g.push(f);
                for (j = g.length; j--;) g[j]._dist > l && g.splice(j, 1);
                if (g.length && g[0].clientX !== b.hoverX) e.refresh(g, a),
                b.hoverX = g[0].clientX
            }
            if (i && i.tracker) {
        ...
        reset: function(a) {
            ...
            d = b.hoverPoint,
            e = b.tooltip,
            f = e && e.shared ? b.hoverPoints: d; (a = a && e && f) && ja(f)[0].plotX === r && (a = !1);
            if (a) e.refresh(f),
            d && d.setState(d.state, !0);
                ...
                if (c) c.onMouseOut();
                e && e.hide();
                if (this._onDocumentMouseMove) X(F, "mousemove", this._onDocumentMouseMove),
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            ...
            w = !r && c[1][l],
            y,
            c = function() { ! r && O(v - u) > 20 && (q = h || O(t - w) / O(v - u));
                o = (p - t) / q + v;
        ...
        pinch: function(a) {
            ...
            function(a) {
                ...
                b.hasPinched = k;
                b.scaleGroups(m, n); ! k && e && g === 1 && this.runPointActions(b.normalize(a))
            }
        },
        ...
        onContainerClick: function(a) {
            ...
            }), N(c.series, "click", u(a, {
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && N(b, "click", a))
        },
        ...
        setDOMEvents: function() {
            ...
            b = a.chart.container,
            c;
            this._events = c = [[b, "onmousedown", "onContainerMouseDown"], [b, "onmousemove", "onContainerMouseMove"], [b, "onclick", "onContainerClick"], [b, "mouseleave", "onContainerMouseLeave"], [F, "mouseup", "onDocumentMouseUp"]];
    ...
    if (V.PointerEvent || V.MSPointerEvent) {
        ...
        U($a.prototype, "setDOMEvents",
        function(a) {
            var b = this;
            a.apply(this, Array.prototype.slice.call(arguments, 1));
            q([[this.chart.container, "PointerDown", "touchstart", "onContainerTouchStart",
            function(a) {
                ta[a.pointerId] = {
                    pageX: a.pageX,
                    pageY: a.pageY,
            ...
            function(a) {
                A(a[0], window.PointerEvent ? a[1].toLowerCase() : "MS" + a[1],
                function(d) {
                    d = d.originalEvent;
                    if (d.pointerType === "touch" || d.pointerType === d.MSPOINTER_TYPE_TOUCH) a[4](d),
                    b[a[3]]({
                        type: a[2],
    ...
    Jb.prototype = {
        init: function(a, b) {
            ...
            f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.baseline = E(d.fontSize) + 3 + f,
            c.itemStyle = d,
        ...
        renderItem: function(a) {
            ...
            t = t && t.showCheckbox,
            u = e.useHTML;
            if (!x && (a.legendGroup = d.g("legend-item").attr({
                zIndex: 1
            }).add(b.scrollGroup), r.drawLegendSymbol(b, a), a.legendItem = x = d.text(e.labelFormat ? Ha(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h: -h, b.baseline, u).css(w(a.visible ? i: j)).attr({
                align: m ? "left": "right",
                zIndex: 2
            }).add(a.legendGroup), (u ? x: a.legendGroup).on("mouseover",
            function() {
                a.setState("hover");
            ...
            }), b.colorizeItem(a, a.visible), t)) a.checkbox = Z("input", {
                type: "checkbox",
                checked: a.selected,
            ...
            d = x.getBBox();
            C = a.legendItemWidth = e.itemWidth || a.legendItemWidth || g + h + d.width + l + (t ? 20 : 0),
            e = C;
            b.itemHeight = g = v(a.legendItemHeight || d.height);
            if (f && b.itemX - J + e > (p || c.chartWidth - 2 * k - J)) b.itemX = J,
            b.itemY += q + b.lastLineHeight + n,
            b.lastLineHeight = 0;
    ...
    /Trident\/7\.0/.test(za) && U(Jb.prototype, "positionItem",
    function(a, b) {
        var c = this,
        d = function() {
    ...
    ya.prototype = {
        ...
        initSeries: function(a) {
            var b = this.options.chart; (b = D[a.type || b.type || b.defaultSeriesType]) || pa(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
        ...
        zoom: function(a) {
            ...
            else if (!d && aa(e)) this.resetZoomButton = e.destroy();
        ...
        pan: function(a, b) {
            ...
            function(b) {
                ...
                h.series.length && l > y(k.dataMin, k.min) && i < s(k.dataMax, k.max) && (h.setExtremes(l, i, !1, !1, {
                    trigger: "pan"
                }), e = !0);
        ...
        setTitle: function(a, b) {
            ...
            f = d.subtitle = w(d.subtitle, b),
            d = f;
            q([["title", a, e], ["subtitle", b, d]],
            function(a) {
                var b = a[0],
                d = c[b],
                e = a[1],
        ...
        layOutTitles: function() {
            ...
            d), !1, "spacingBox"), !d.floating && !d.verticalAlign && (a = Va(a + c.getBBox().height)));
            this.titleOffset = a
        },
        ...
        cloneRenderTo: function(a) {
            ...
            c = this.container;
            a ? b && (this.renderTo.appendChild(c), Sa(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), z(b, {
                position: "absolute",
                top: "-9999px",
                display: "block"
        ...
        getContainer: function() {
            ...
            a || pa(13, !0);
            c = E(H(a, "data-highcharts-chart")); ! isNaN(c) && Wa[c] && Wa[c].destroy();
        ...
        setSize: function(a, b, c) {
            ...
            if (t(a)) d.chartWidth = e = s(0, v(a)),
            d.hasUserSize = !!e;
            if (t(b)) d.chartHeight = f = s(0, v(b)); (wa ? ob: z)(d.container, {
                width: e + "px",
                height: f + "px"
            },
            wa);
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(s) : this.plotBackground = b.rect(n, o, q, x, 0).attr({
                fill: k
        ...
        isReadyToRender: function() {
            var a = this;
            return ! da && V == V.top && F.readyState !== "complete" || ka && !V.canvg ? (ka ? Vb.push(function() {
                a.firstRender()
            },
            a.options.global.canvasToolsURL) : F.attachEvent("onreadystatechange",
            function() {
    ...
    Da.prototype = {
        ...
        select: function(a, b) {
            ...
            function() {
                ...
                function(a) {
                    ...
                    d.options.data[Aa(a, d.data)] = a.options,
                    a.setState(""),
        ...
        onMouseOut: function() {
            var a = this.series.chart,
            b = a.hoverPoints;
            if (!b || Aa(this, b) === -1) this.firePointEvent("mouseOut"),
            this.setState(),
            a.hoverPoint = null
        },
        ...
        setState: function(a, b) {
            ...
            if (! (a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && !i.enabled) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic) f = g && this.graphic.symbolName && p[a].r,
                this.graphic.attr(w(p[a], f ? {
                    x: c - f,
                    y: d - f,
                    width: 2 * f,
                    height: 2 * f
                    ...
                    else e.stateMarkerGraphic = k = m.renderer.symbol(l, c - f, d - f, 2 * f, 2 * f).attr(p[a]).add(e.markerGroup),
                    k.currentSymbol = l;
    ...
    M.prototype = {
        ...
        setData: function(a, b) {
            ...
            if (j && k > j) {
                ...
                if (ua(g)) {
                    ...
                    i += e;
                    c.xIncrement = i
                } else if (Pa(g)) if (p) for (j = 0; j < k; j++) e = a[j],
                l[j] = e[0],
                m[j] = e.slice(1, p + 1);
                else for (j = 0; j < k; j++) e = a[j],
                l[j] = e[0],
                m[j] = e[1];
                else pa(12)
            } else for (j = 0; j < k; j++) if (a[j] !== r && (e = {
                series: c
            },
            c.pointClass.prototype.applyOptions.apply(e, [a[j]]), c.updateParallelArrays(e, j), i && e.name)) h.names[e.x] = e.name;
            ma(m[0]) && pa(14, !0);
            c.data = [];
            c.options.data = a;
        ...
        processData: function(a) {
            ...
            d > 0 && (g === r || d < g) ? g = d: d < 0 && this.requireSorting && pa(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            ...
            b = this.data = b;
            for (m = 0; m < g; m++) i = h + m,
            j ? l[m] = (new f).init(this, [d[m]].concat(ja(e[m]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
        ...
        translate: function() {
            ...
            h = !!this.modifyValue,
            i = a.pointPlacement,
            j = i === "between" || ua(i), k = a.threshold, a = 0; a < g; a++) {
                var l = f[a],
                m = l.x,
                p = l.y,
                n = l.low,
                q = b && e.stacks[(this.negStacks && p < k ? "-": "") + this.stackKey];
                if (e.isLog && p <= 0) l.y = p = null;
                l.plotX = c.translate(m, 0, 0, 0, 1, i, this.type === "flags");
                if (b && this.visible && q && q[m]) q = q[m],
                p = q.points[this.index],
                n = p[0],
                p = p[1],
                n === 0 && (n = o(k, e.min)),
                e.isLog && n <= 0 && (n = null),
                l.total = l.stackTotal = q.total,
                l.percentage = b === "percent" && l.y / q.total * 100,
                l.stackY = p,
        ...
        drawPoints: function() {
            ...
            if (l.enabled || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = Q(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {},
            a = l.enabled && i.enabled === r || i.enabled, m = c.isInsidePlot(v(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({
                visibility: m ? da ? "inherit": "visible": "hidden"
            }).animate(u({
                x: d - h,
                y: e - h
            },
    ...
    u(ya.prototype, {
        ...
        showLoading: function(a) {
            ...
            this.loadingSpan = Z("span", null, d.labelStyle, c);
    ...
    ia = ea(M, {
        ...
        translate: function() {
            ...
            function(a) {
                ...
                x,
                c = s(c, b) - r;
                O(c) < f && f && (c = f, r = v(O(r - e) > f ? b - f: e - (d.translate(a.y, 0, 1, 0, 1) <= e ? f: 0)));
                a.barX = n;
                a.pointWidth = g;
                b = O(n) < 0.5;
                q = v(n + q) + j;
        ...
        drawPoints: function() {
            ...
            function(g) {
                var h = g.plotY,
                i = g.graphic;
                if (h !== r && !isNaN(h) && g.y !== null) f = g.shapeArgs,
                i ? (eb(i), i[b.pointCount < e ? "animate": "attr"](w(f))) : g.graphic = d[g.shapeType](f).attr(g.pointAttr[g.selected ? "select": ""]).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
        ...
        animate: function(a) {
            ...
            e = {};
            if (da) a ? (e.scaleY = 0.001, a = y(b.pos + b.len, s(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len: e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX": "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function() {
            var a = this,
            b = a.chart;
    ...
    M.prototype.drawDataLabels = function() {
        ...
        function(b) {
            ...
            if (k && !j) b.dataLabel = k.destroy();
                ...
                j = d.rotation;
                l = b.getLabelConfig();
                g = d.format ? Ha(d.format, l) : d.formatter.call(l, d);
                ...
                n = !1;
                    ...
                    k = b.dataLabel = a.chart.renderer[j ? "text": "label"](g, 0, -999, null, null, null, d.useHTML).attr(k).css(u(d.style, c && {
                        cursor: c
    ...
    if (D.pie) D.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (G = 0; ! w && b[G];) w = b[G] && b[G].dataLabel && (b[G].dataLabel.getBBox().height || 21),
            G++;
            for (G = 2; G--;) {
                var b = [],
                F = [],
                ...
                if (l > 0) {
                    ...
                    for (C = 0; C < B; C++) {
                        ...
                        c = 9999;
                        var L, K;
                        for (K = 0; K < x; K++) L = O(b[K] - u[1]),
                        L < c && (c = L, z = K);
                        if (z < C && b[C] !== null) z = C;
                        else for (x < B - C + z && b[C] !== null && (z = x - B + C); b[z] === null;) z++;
                        F.push({
                            i: z,
                            y: b[z]
                        });
                ...
                for (C = 0; C < B; C++) {
                    ...
                    t.connX = A;
                    t.connY = I;
                    if (this.options.size === null) x = t.width,
                    A - x < f ? P[3] = s(v(x - A + f), P[3]) : A + x > h - f && (P[1] = s(v(A + x - h + f), P[1])),
                    I - w / 2 < 0 ? P[0] = s(v( - I + w / 2), P[0]) : I + w / 2 > d && (P[2] = s(v(I + w / 2 - d), P[2]))
                }
            }
            if (va(P) === 0 || this.verifyDataLabelOverflow(P)) this.placeDataLabels(),
            r && g && q(this.points,
            function(b) {
                i = b.connector;
                u = b.labelPos;
                if ((t = b.dataLabel) && t._pos) E = t._attr.visibility,
                A = t.connX,
                I = t.connY,
                j = k ? ["M", A + (u[6] === "left" ? 5 : -5), I, "C", A, I, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), I, "L", u[2], u[3], "L", u[4], u[5]],
                i ? (i.animate({
                    d: j
    ...
    D.pie.prototype.alignDataLabel = la,
    D.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
        c = this.options,
        d = c.center,
        e = c = c.minSize || 80,
    ...
    function(a, b, c, d, e, f, g, h) {
        ...
        if (h && a.unitRange <= B.hour) {
            j = o.length - 1;
            for (i = 1; i < j; i++)(new Date(o[i] - Ja))[Ua]() !== (new Date(o[i - 1] - Ja))[Ua]() && (l[o[i]] = "day", m = !0);
            m && (l[o[0]] = "day");
            a.higherRanks = l
        }
        o.info = a;
        if (h && t(x)) {
            ...
            m < x * 0.6 && (m = null);
            h = o[a - 1] > d ? a - 1 : a;
            for (s = void 0; h--;) i = j[h],
            d = s - i,
            s && d < x * 0.8 && (m === null || d < m * 0.8) ? (l[o[h]] && !l[o[h + 1]] ? (d = h + 1, s = i) : d = h, o.splice(d, 1)) : s = i
        }
        return o
    });
    u(W.prototype, {
        ...
        lin2val: function(a, b) {
            ...
            if (c) {
                ...
                f = c.length - 1,
                g, h;
                if (b) a < 0 ? a = c[0] : a > f ? a = c[f] : (f = Q(a), h = a - f);
    ...
    function(a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                ...
                f < 0 ? (k = m, n = c.ordinalPositions ? c: m) : (k = c.ordinalPositions ? c: m, n = m),
                m = n.ordinalPositions,
                h > m[m.length - 1] && m.push(h),
                f = c.toFixedRange(null, null, l.apply(k, [p.apply(k, [i, !0]) + f, !0]), l.apply(n, [p.apply(n, [j, !0]) + f, !0])),
                f.min >= y(g.dataMin, i) && f.max <= s(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
                }),
                this.mouseDownX = d,
                z(this.container, {
    ...
    jc = {
        ...
        groupPixelWidth: 2,
        dateTimeLabelFormats: gb("millisecond", ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], "second", ["%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S"], "minute", ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], "hour", ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], "day", ["%A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], "week", ["Week from %A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], "month", ["%B %Y", "%B", "-%B %Y"], "year", ["%Y", "%Y", "-%Y"])
    },
    Wb = {
        line: {},
        spline: {},
    ...
    Y.groupData = function(a, b, c, d) {
        ...
        for (o = 0; o <= i; o++) {
            ...
            if (p) {
                ...
                [f[j]]);
                var q;
                for (k = 0; k < n; k++) if (q = j[p[k]], typeof q === "number") m[k].push(q);
                else if (q === null) m[k].hasNulls = !0
            } else if (j = l ? b[o] : null, typeof j === "number") m[0].push(j);
    ...
    Y.tooltipHeaderFormatter = function(a) {
        ...
        if (f && f.options.type === "datetime" && c && ua(a.key)) {
            ...
            if (g) f = c[g.unitName],
            g.count === 1 ? d = f[0] : (d = f[1], e = f[2]);
            else if (!d && c) for (h in B) if (B[h] >= f.closestPointRange) {
                d = c[h][0];
                break
            }
            d = ra(d, a.key);
    ...
    R = ea(D.column, {
        ...
        drawPoints: function() {
            ...
            function(k) {
                ...
                c = k.pointAttr[k.selected ? "selected": ""],
                f = c["stroke-width"] % 2 / 2,
                j = v(k.plotX) + f,
                g = v(k.shapeArgs.width / 2),
                h = ["M", j, v(k.yBottom), "L", j, v(k.plotY)],
                k.open !== null && (d = v(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)),
                k.close !== null && (e = v(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)),
                i ? i.animate({
                    d: h
    ...
    R = ea(R, {
        ...
        drawPoints: function() {
            ...
            function(n) {
                l = n.graphic;
                if (n.plotY !== r) c = n.pointAttr[n.selected ? "selected": ""],
                ...
                f = T.min(d, e),
                g = T.max(d, e),
                p = v(n.shapeArgs.width / 2),
                h = v(f) !== v(n.plotY),
                i = g !== n.yBottom,
                f = v(f) + j,
                g = v(g) + j,
                m = ["M", k - p, g, "L", k - p, f, "L", k + p, f, "L", k + p, g, "L", k - p, g, "M", k, f, "L", k, h ? v(n.plotY) : f, "M", k, g, "L", k, i ? v(n.yBottom) : g, "Z"],
                l ? l.animate({
                    d: m
                }) : n.graphic = b.renderer.path(m).attr(c).add(a.group).shadow(a.options.shadow)
            })
        }
    });
    D.candlestick = R;
    ...
    D.flags = ea(D.column, {
        ...
        drawPoints: function() {
            ...
            d, e, f = this.options,
            g = f.y,
            h, i, j, k, l = f.lineWidth % 2 / 2,
            m, p;
            for (i = b.length; i--;) if (j = b[i], a = j.plotX > this.xAxis.len, d = j.plotX + (a ? l: -l), k = j.stackIndex, h = j.options.shape || f.shape, e = j.plotY, e !== r && (e = j.plotY + g + l - (k !== r && k * f.stackDistance)), m = k ? r: j.plotX + l, p = k ? r: j.plotY, k = j.graphic, e !== r && d >= 0 && !a) a = j.pointAttr[j.selected ? "select": ""],
            k ? k.attr({
                x: d,
                y: e,
                r: a.r,
                ...
                width: f.width,
                height: f.height
            }).add(this.markerGroup).shadow(f.shadow),
            j.tooltipPos = [d, e];
            else if (k) j.graphic = k.destroy()
        },
    ...
    Za === Highcharts.VMLRenderer && q(["flag", "circlepin", "squarepin"],
    function(a) {
    ...
    Bb.prototype = {
        ...
        render: function(a, b, c, d) {
            ...
            if (!isNaN(a)) {
                ...
                a = c - b;
                if (!this.rendered) {
                    if (A) this.navigatorGroup = l = f.g("navigator").attr({
                        zIndex: 3
                    }).add(),
                    ...
                    if (q) this.scrollbarGroup = k = f.g("scrollbar").add(),
                    m = x.trackBorderWidth,
                ...
                A && (this.leftShade[e]({
                    ...
                    d: ["M", i, B, "L", g + b + z, B, g + b + z, B + C - n, "M", g + c - z, B + C - n, "L", g + c - z, B, i + j, B]
                }), this.drawHandle(b + z, 0), this.drawHandle(c + z, 1));
                if (q && k) this.drawScrollbarButton(0),
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                ...
                u,
                v = cb ? 10 : 7;
                if (t > h && t < h + g + j) if ((h = !a.scrollbarEnabled || t < h + g) && T.abs(s - e - p) < v) a.grabbedLeft = !0,
                a.otherHandlePos = f,
                a.fixedExtreme = d.max,
                b.fixedRange = null;
                else if (h && T.abs(s - f - p) < v) a.grabbedRight = !0,
                a.otherHandlePos = e,
                ...
                b.fixedRange = null;
                    ...
                    a.grabbedCenter = s;
                    a.fixedWidth = r;
                    if (b.renderer.isSVG) l = k.cursor,
                    k.cursor = "ew-resize";
                    i = s - e
                } else if (s > m && s < m + n) {
        ...
        updatedDataHandler: function() {
            ...
            i = e <= g;
            if (!a.hasNavigatorData) p.options.pointStart = b.xData[0],
            p.setData(b.options.data, !1),
            m = !0;
            i && (l = g, k = l + h);
            j && (k = d, i || (l = s(k - h, p.xData[0])));
            n && (i || j) ? isNaN(l) || c.setExtremes(l, k, !0, !1, {
                trigger: "updatedData"
            }) : (m && this.chart.redraw(!1), a.render(s(e, g), y(f, d)))
        },
        destroy: function() {
            this.removeEvents();
    ...
    Cb.prototype = {
        clickButton: function(a, b) {
            ...
            if (! (j === null || k === null || a === c.selected)) {
                ...
                p["set" + l](p["get" + l]() - t),
                l = p.getTime(),
                j = o(j, Number.MIN_VALUE),
                isNaN(l) || l < j ? (l = j, m = y(l + i, k)) : i = m - l;
                else if (i) l = s(m - i, j),
                m = y(l + i, k);
                else if (n === "ytd") if (h) {
        ...
        drawInput: function(a) {
            ...
            this[a + "Label"] = j = e.label(L.lang[h ? "rangeSelectorFrom": "rangeSelectorTo"], this.inputGroup.offset).attr({
                padding: 1
            ...
            i.onchange = function() {
                ...
                isNaN(d) || (L.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = r: d < g && (d = g) : d < b.minInput.HCTime ? d = r: d > j && (d = j), d !== r && c.xAxis[0].setExtremes(h ? d: e.min, h ? e.max: d, r, r, {
        ...
        render: function(a, b) {
            ...
            n = d.plotLeft,
            r;
            if (!c.rendered && (c.zoomText = e.text(g.rangeSelectorZoom, n, d.plotTop - 10).css(i.labelStyle).add(), r = n + c.zoomText.getBBox().width + 5, q(c.buttonOptions,
            function(a, b) {
                j[b] = e.button(a.text, r, d.plotTop - 25,
                function() {
                    c.clickButton(b);
                    c.isActive = !0
                },
                l, o && o.hover, o && o.select).css({
                    textAlign: "center"
                }).add();
    ...
    ya.prototype.callbacks.push(function(a) {
        ...
        var f, g = a.scroller,
        h = a.rangeSelector;
        g && (A(a.xAxis[0], "afterSetExtremes", d), U(a, "drawChartBox",
        function(a) {
    ...
    U(W.prototype, "hideCrosshair",
    function(a, b, c) {
        a.call(this, b, c);
        this.crossLabel && this.crossLabel.hide()
    });
    U(W.prototype, "drawCrosshair",
    function(a, b, c) {
        var d, e;
        a.call(this, b, c);
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            ...
            else { ! p && !f.formatter && (this.isDatetimeAxis && (n = "%b %d, %Y"), p = "{value" + (n ? ":" + n: "") + "}");
                k.attr({
                    x: l,
                    y: m,
                    text: p ? Ha(p, {
    ...
    var kc = Y.init,
    lc = Y.processData,
    mc = Da.prototype.tooltipFormatter;
    Y.init = function() {
