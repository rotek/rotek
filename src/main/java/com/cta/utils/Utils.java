...
//		CacheEngine cacheEngine = (CacheEngine) Class.forName("com.cta.platform.cache.MemcacheEngine").newInstance();
...
//		System.out.println(sdf.parse(time).getTime() < sdf.parse(begin).getTime());
