...
public class FrontLoginInterceptor extends BaseInterceptor{
	...
	* @return
	* @throws Exception
	* @see com.cta.platform.interceptor.BaseInterceptor#preHandle(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, java.lang.Object)
	*/
	@Override
	public boolean preHandle(HttpServletRequest request,
		...
		if(null != session && null != session.getAttribute("user")){
			...
			UserDto user = loginDao.getUser("a","a");
