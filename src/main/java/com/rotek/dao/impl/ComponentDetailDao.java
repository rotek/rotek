...
public class ComponentDetailDao extends BaseDaoImpl {
	 ...
	 * @author WangJuZhu
	 */
	public List<ComponentDetailDto> listComDetail(String sql, Object[] params,
	 ...
	 * @author WangJuZhu
	 */
	public List<ProjectEntity> listProjectByStatus(Integer status)
			throws SQLException {
	 ...
	 * @author WangJuZhu
	 */
	public void addComDetail(ComponentDetailEntity comgroup)
			throws SQLException {
	 ...
	 * @author WangJuZhu
	 */
	public ComponentDetailEntity getComDetailById(Integer id)
			throws SQLException {
		String sql = "select * from r_component_detail where id = ?";
		return this.selectOne(sql, new Integer[] { id },
	 ...
	 * @author WangJuZhu
	 */
	public void modifyComDetail(ComponentDetailEntity comgroup)
			throws SQLException {
