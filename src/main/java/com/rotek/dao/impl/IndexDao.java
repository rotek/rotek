...
public class IndexDao extends BaseDaoImpl{
	...
	* @throws
	*/
	public Map<String, Object> getOrderCount(Integer dep_id, Date date) throws SQLException {

		StringBuilder sql = new StringBuilder();
		sql.append("select count(*) count from mf_order where rest_id in");
		...
		return this.executeQueryOne(sql.toString(), new Object[]{dep_id,dep_id, date});
	}
	...
	*/
	public Map<String, Object> getGiftCount(Date date) throws SQLException {
		...
		String sql = "select count(*) count from mf_gift_user where time_exchange > ?";
