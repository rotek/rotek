...
public interface IBaseDao {
	...
	* @throws
	*/
	<T> List<T> selerotekll(String sql,Class<T> clazz) throws SQLException;
	 ...
	 * @throws
	 */
	<T> List<T> selerotekll(String sql,Object[] parameters,Class<T> clazz) throws SQLException;
