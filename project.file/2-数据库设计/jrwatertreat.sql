...
CREATE TABLE `agentidentityinfo` (
  ...
  `AgentID` int(11) NOT NULL,
  `DLSZJMC` varchar(255) DEFAULT NULL,
  `DLSZJYXQ` varchar(255) DEFAULT NULL,
  `DLSZJZP` varchar(255) DEFAULT NULL,
...
CREATE TABLE `agentinfo` (
  ...
  `DLSMC` varchar(255) NOT NULL,
  `DLSTXDZ` varchar(255) NOT NULL,
  `DLSLXFS` varchar(255) DEFAULT NULL,
  `DLSLXR` varchar(255) NOT NULL,
  `DLQY` varchar(255) DEFAULT NULL,
  `SSJB` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`AgentID`),
...
CREATE TABLE `complaintinfo` (
  ...
  `AgentID` int(11) NOT NULL,
  `DLSMC` varchar(255) DEFAULT NULL,
  `TSDW` varchar(255) DEFAULT NULL,
  `TSSX` varchar(255) DEFAULT NULL,
...
CREATE TABLE `componentinfo` (
  ...
  `ProjectID` int(11) NOT NULL,
  `LJBH` varchar(255) DEFAULT NULL,
  `LJLB` varchar(255) DEFAULT NULL,
  `LJBM` varchar(255) DEFAULT NULL,
...
CREATE TABLE `customerdatainfo` (
  ...
  `ZLDZ` varchar(255) DEFAULT NULL,
  `ZLMC` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`DataID`),
...
CREATE TABLE `customerinfo` (
  ...
  `KHJWDDZ` varchar(255) NOT NULL,
  `KHTXDZ` varchar(255) DEFAULT NULL,
...
CREATE TABLE `customerprojectinfo` (
  ...
  `CustomerID` int(11) NOT NULL,
  `GCMC` varchar(255) NOT NULL,
  `GCBH` varchar(255) NOT NULL,
  `LocaleGCBH` varchar(255) DEFAULT NULL,
  `GCFL` enum('') DEFAULT NULL,
  `GCJS` varchar(255) DEFAULT NULL,
  `GCXH` varchar(255) DEFAULT NULL,
  `GCZP` varchar(255) DEFAULT NULL,
  `JSCSJJ` varchar(255) DEFAULT NULL,
  `JSCSFJ` varchar(255) DEFAULT NULL,
  `GCLJ` varchar(255) DEFAULT NULL,
  `AZSJ` varchar(255) DEFAULT NULL,
  `TYSJ` varchar(255) DEFAULT NULL,
...
CREATE TABLE `dosesettinggroupinfo` (
  ...
  `ComponentID` int(11) NOT NULL,
  `YJPP` varchar(255) DEFAULT NULL,
  `YJXH` varchar(255) DEFAULT NULL,
...
CREATE TABLE `filmgroupinfo` (
  ...
  `ComponentID` int(11) NOT NULL,
  `PLFS` varchar(255) DEFAULT NULL,
  `MKGG` varchar(255) DEFAULT NULL,
  `MZSL` int(11) DEFAULT NULL,
  `CSL` int(11) DEFAULT NULL,
  `MPP` varchar(255) DEFAULT NULL,
...
CREATE TABLE `filtergroupinfo` (
  ...
  `LXCZ` varchar(255) DEFAULT NULL,
  `LXPP` varchar(255) DEFAULT NULL,
  `LXXH` varchar(255) DEFAULT NULL,
  `LXJKXS` varchar(255) DEFAULT NULL,
...
CREATE TABLE `maintainceservicesdetail` (
  ...
  `FWNR` varchar(255) DEFAULT NULL,
  `FWGS` varchar(255) DEFAULT NULL,
  `FWRY` varchar(255) DEFAULT NULL,
  `FWPJ` varchar(255) DEFAULT NULL,
...
CREATE TABLE `projectdatainfo` (
  ...
  `ProjectID` int(11) NOT NULL,
  `GCZLMC` varchar(255) DEFAULT NULL,
  `GCZLJJ` varchar(255) DEFAULT NULL,
  `GCZLLX` enum('') DEFAULT NULL,
  `GCZLLJ` varchar(255) DEFAULT NULL,
  `GCJCTLX` varchar(255) DEFAULT NULL,
...
CREATE TABLE `sandfiltergroupinfo` (
  ...
  `CZ` varchar(255) DEFAULT NULL,
  `LLSL` int(11) DEFAULT NULL,
  `LLPP` varchar(255) DEFAULT NULL,
  `LLXH` varchar(255) DEFAULT NULL,
...
CREATE TABLE `uvsterilizergroupinfo` (
  ...
  `DGPP` varchar(255) DEFAULT NULL,
  `DGXH` varchar(255) DEFAULT NULL,
